...
from anemic.decorators import deprecated
from anemic.i18n import configure_i18n
from anemic.util.collections import flatten
from anemic.util.path import caller_package


class AnemicAppFactory(object):
    """
    ...
    @classmethod
    def instantiate(cls):
        return super(AnemicAppFactory, cls).__new__(cls)

    def __init__(self, *args, **kwargs):
        super(AnemicAppFactory, self).__init__()
...
def create_configurator(
    ...
    **kw,
    ...
    config.registry.anemic_features = feature_set
...
def application_factory(
    ...
    **extra_parameters,
    ...
    automatically included in the application. By default all standard Anemic
